				...
				<view class="course-main" v-if="videos.length>0">
					...
					<view class="mtt" v-for="(item,index) in videos" :key="index" :index="index">
						<view class="mtt-left">
							...
							<view class="png-yuan">
								<image src="../../static/live/组66(1).png" class="mtt-left-img"></image>
								<image src="../../static/live/虚线.png" class="mtt-left-line" mode=""></image>
							</view>
						...
						<view class="" @tap="changVideosClick(item)">
								<image src="../../static/live/播放(1).png" class="mtt-text"></image>
						</view>
