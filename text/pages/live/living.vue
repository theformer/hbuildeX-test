	...
	<view class="living">
		...
		<view class="header">
			<view class="header-saw">
				<image src="../../static/live/组 75.png" class="header-img"></image>
				<text class="header-text" @click="linkToLiveReview">直播精彩回顾</text>
			</view>
			<view class="header-saw">
				<image src="../../static/live/组 75(1).png" class="header-img"></image>
				<text class="header-text" @click="linkToRecorded">录播课程</text>
			</view>
		</view>
		<view>
			<view class="mian-header">
			<image src="../../static/live/矩形 1.png" class="tip"></image>
					...
					<view  class="living-teacher-right-top">
						...
						<view class="living-teacher-foot">
							<view class="foot-left">
								<image class="photo" src="../../static/live/组 68.png"></image>
								<view class="xiaban">
							...
							<view class="foot-right">
								<view class="footer-living" v-if="item.state ==1">
										<image src="../../static/live/预约.png" class="foot-png"></image>
