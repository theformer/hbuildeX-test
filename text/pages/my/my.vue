	...
	<view class="my">
		...
		<view class="container">
			<view class="container__head" @click="linkToMyCourse" v-if="!flag">
				<image src="../../static/my/我的课程(1).png" class="container__head--img"></image>
			...
			<view class="container__head" @click="linkToLearning">
				<image src="../../static/my/进度.png" class="container__head--img"></image>
				<text class="container__head--feedback">学习进度</text>
				<image src="../../static/my/next.png" class="container__menu--img"></image>	
			</view>
			<view class="container__head" @click="linkToScoreInquiry">
				<image src="../../static/my/组68(1).png" class="container__head--img"></image>
				<text class="container__head--feedback">成绩查询</text>
				<image src="../../static/my/next.png" class="container__menu--img"></image>
			</view>
			<view class="container__head" @click="linkToChange">
				<image class="container__head--img" src="../../static/my/修改密码.png"></image>
