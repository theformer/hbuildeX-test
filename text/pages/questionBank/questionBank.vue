<template>
	<view class="questionBank">
		...
		<view class="header">
			...
			<image src="../../static/questionBank/加.png" @click="sumQuestionClick"  class="sum"></image>
		</view>
		<text class="line"></text>
		<view class="container">
			<view class="container-column" @click="linkToChapter" v-if="status">
				<image class="img-with" src="../../static/questionBank/图层 9.png"></image>
				<text>章节练习</text>
			</view>
			<view class="container-column" @click="linkToDaily" v-if="status">
				<image class="img-with" src="../../static/questionBank/图层 7.png"></image>
				<text>每日一练</text>
			</view>
			...
			<view class="container-column" @click="linkToExam">
				<image class="img-with" src="../../static/questionBank/图层 8.png"></image>
				<text>历年真题</text>
			</view>
			<view class="container-column" @click="linkToSimulation">
				<image class="img-with" src="../../static/questionBank/图层 6.png"></image>
				<text>模拟练习</text>
			</view>
			<view class="container-column" @click="wrongTopic">
				<image class="img-with" src="../../static/questionBank/组 81.png"></image>
				<text>错题本</text>
			</view>
		</view>
		<view class="footer" v-if="listCourse.length>0">
			<view class="footer-thead">
				<image class="footer-icon" src="../../static/questionBank/矩形 1.png"></image>
