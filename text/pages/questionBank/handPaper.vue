<template>
	...
	<view class="handPaper">
		...
		<view class="handPaper-container">
			<view class="allPaper">
				<image src="../../static/questionBank/文件.png" class="tip-png"></image>
			...
			<view class="allPaper">
				<image src="../../static/questionBank/笔记.png" class="tip-png"></image>
				<view class="tip-right">
			...
			<view class="line"></view>
			<view class="allPaper">
				<image src="../../static/questionBank/对.png" class="tip-png"></image>
				<view class="tip-right">
			...
			<view class="line"></view>
			<view class="allPaper">
				<image src="../../static/questionBank/授信通过率.png" class="tip-png"></image>
				<view class="tip-right">
		...
		<view class="footer">
			<view class="footer-head">
				<image src="../../static/questionBank/灯.png" mode="" class="footer-head-png"></image>
