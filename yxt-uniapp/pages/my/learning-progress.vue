	...
	<view class="learning-progress">
		<view class="demo" :style="'height:' +  demo.height + 'px;' + 'padding-top:' + demo.top + 'px;padding-bottom:10rpx'">
				  ...
				  <view class="">
					...
					<image class="changeCertificate" src="/static/questionBank/cut.png" v-if="progress.length>1" @click="changeCertificate"></image>
				  </view>
					<view class="">
						<image src="/static/my/nextNext.png" class="hidden" mode=""></image>
					</view>
		</view>
		<view class="line-course" v-for="(item,index) in progress">
			...
			<view class="mtr">
				...
				<image src="/static/my/nextNext.png" class="img"></image>
			</view>
